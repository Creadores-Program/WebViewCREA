...
         : `<script>window.location.href = "${targetUrl}";</script>`;
  ...
  const strScripts = loadPolyfills()+headpoly+matchMediaPoly+(isDarkTheme ? `<script type='text/javascript'>\n${polyDark}\n</script>\n` : "")+es5shims+es6shims+coreJsScript+intlPoly+globalPoly+urlPoly+underscore+html5ShivScript+dom4+dialogPoly+websocketPoly+webRtc;
  if ($('head').length > 0) {
