...
export default async function patchHtml(html, headers) {
  ...
  const urlPoly = '<script type="text/javascript" src="https://cdn.jsdelivr.net/combine/npm/url-polyfill/url-polyfill.min.js,npm/json3/lib/json3.min.js,gh/GoogleChrome/proxy-polyfill/proxy.min.js,npm/js-big-integer/BigInteger.min.js,npm/fetch-polyfill/fetch.js,npm/unorm/lib/unorm.min.js,npm/intersection-observer/intersection-observer.min.js,npm/resize-observer-polyfill/dist/ResizeObserver.min.js,gh/browserstate/history.js/scripts/bundled/html4%2Bhtml5/native.history.js,npm/@webcomponents/webcomponentsjs/webcomponents-bundle.min.js,npm/web-streams-polyfill/dist/polyfill.es5.js,gh/remy/polyfills@master/offline-events.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>\n';
  ...
  const globalPoly = '<script type="text/javascript">\nwindow.globalThis = window.globalThis || window; window.queueMicrotask = window.queueMicrotask || function(fn) { Promise.resolve().then(fn)["catch"](function(err) { setTimeout(fn, 0); }); };\n</script>\n';
  const strScripts = loadPolyfills()+headpoly+globalPoly+es5shims+es6shims+coreJsScript/*+intlPoly*/+urlPoly+underscore+html5ShivScript+dom4+dialogPoly+websocketPoly+webRtc;
  if ($('head').length > 0) {
